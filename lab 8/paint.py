...
class Brush():
    def __init__(self):
        ...
        self.mode = 'draw'
        self.icon = 'brush'
        self.image = pygame.transform.scale(pygame.image.load('./paint.assets/brush.png'), (100, 100))
    ...
    def update(self):
        self.pos = pygame.mouse.get_pos()
        self.image = pygame.transform.scale(pygame.image.load(f'./paint.assets/{self.icon}.png'), (50, 50))
        self.rect = self.image.get_rect()
